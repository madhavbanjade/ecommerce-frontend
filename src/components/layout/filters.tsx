    ...
    <>
      <div className="space-y-4 p-2">
        ...
        <div className="space-y-3">
          <h5 className="text-[10px] font-bold  uppercase text-zinc-400">
            Gender
          </h5>
          <div className="space-y-2">
            {Gender.map((g) => (
              ...
              >
                ...
                />
                <span className="text-xs text-zinc-600 group-hover:text-black  transition-colors">
                  {g}
                </span>
              </label>
            ))}
            ...
            {Categories.map((cat) => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    updateParam("category", cat, e.target.checked)
                  }
                  className="w-4 h-4 rounded border-zinc-300 accent-black cursor-pointer"
                />
                <span className="text-xs text-zinc-600 group-hover:text-black  transition-colors">
        ...
        <div className="space-y-3">
          <h5 className="text-[10px] font-bold tracking-[0.2em] uppercase text-zinc-400">
            Size
          </h5>
