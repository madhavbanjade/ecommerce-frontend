...
function ProductSection({
  ...
  <div className="relative text-center">
    ...
    <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-14 h-[2px] rounded-sm bg-gradient-to-r from-transparent via-zinc-900 to-transparent" />
  </div>
